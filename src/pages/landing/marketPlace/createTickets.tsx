...
const CreateTickets = ({ navigation }) => {

    const windowWidth = useWindowDimensions().width;
    const [name, setName] = useState('Topic here');
                ...
                <View >
                    ...
                    <View style = {{flexDirection: 'row', width: vw(95), flexWrap: 'wrap', marginLeft: vw(5)}}>
                        <View style = {styles.inputStyle}>
                            ...
                            />
                            <View  style = {{ width: vw(90), borderBottomColor: name ? '#53FAFB' : '#9D9D9D', height:0, borderBottomWidth: vw(0.6)}}/>
                            <Text style = {styles.subtitle}>
                        ...
                        <View style = {[styles.inputStyle, {marginTop: vw(10)}]}>
                            <TextInput
                                ...
                                placeholder = "Describe your topic's description"
                                placeholderTextColor='#9D9D9D'
                                value = {description}
                                ...
                                keyboardType = 'default'
                            />
                            <View style = {{ width: vw(90), borderBottomColor: description ? '#53FAFB' : '#9D9D9D', height:0, borderBottomWidth: vw(0.6)}}/>
                            <Text style = {styles.subtitle}>
                                The terms and conditions contained in.
                            </Text>
                        </View>
