...
const GroupCall = ({ navigation }) => {
    ...
    const CallAction  = [
        {
            ...
            online: true,
            name: '@KitshunaFowyu',
            data: {text: 'Sharing Screen', color: '#4DE265'},
            added: <Svg width={vw(3.9)} height={vw(2.8)} viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <Path d="M3.38889 0.5C2.71724 0.5 2.38142 0.5 2.10589 0.573827C1.35819 0.774173 0.774173 1.35819 0.573827 2.10589C0.5 2.38142 0.5 2.71724 0.5 3.38889V6.03333C0.5 7.24678 0.5 7.85351 0.736153 8.31698C0.943878 8.72466 1.27534 9.05612 1.68302 9.26385C2.1465 9.5 2.75322 9.5 3.96667 9.5H10.0333C11.2468 9.5 11.8535 9.5 12.317 9.26385C12.7247 9.05612 13.0561 8.72466 13.2638 8.31698C13.5 7.85351 13.5 7.24678 13.5 6.03333V3.38889C13.5 2.71724 13.5 2.38142 13.4262 2.10589C13.2258 1.35819 12.6418 0.774173 11.8941 0.573827C11.6186 0.5 11.2828 0.5 10.6111 0.5M9.88889 3.38889L7 0.5M7 0.5L4.11111 3.38889M7 0.5V7" stroke="#53FAFB" stroke-linecap="round" stroke-linejoin="round"/>
                </Svg>            
        },
        {
            id: 0,
            ...
            online: true,
            name: '@KitshunaFowyu',
            data: {text: 'Speaking', color: '#53FAFB'},
            added: <Svg width={vw(5.8)} height={vw(5.6)} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <Path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 12.5V12.5C9.11917 12.5 8 11.3808 8 10V5C8 3.61917 9.11917 2.5 10.5 2.5V2.5C11.8808 2.5 13 3.61917 13 5V10C13 11.3808 11.8808 12.5 10.5 12.5Z" stroke="#50FFFF" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M15.5 8.33331V9.99998C15.5 12.7616 13.2617 15 10.5 15V15C7.73833 15 5.5 12.7616 5.5 9.99998V8.33331" stroke="#50FFFF" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M10.5002 15V17.5" stroke="#50FFFF" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M7.0166 17.5H13.9833" stroke="#50FFFF" stroke-linecap="round" stroke-linejoin="round"/>
                </Svg>
    ...
    const friendArray  = [
        {
            ...
            online: true,
            name: '@KitshunaFowyu',
            data: {text: 'Raise hand', color: '#53FAFB'},
            added: <Svg width={vw(4.44)} height={vw(5)} viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <Path d="M3.8 8.55556V10.7778M3.8 8.55556V3.22222C3.8 2.48584 4.4268 1.88889 5.2 1.88889C5.9732 1.88889 6.6 2.48584 6.6 3.22222M3.8 8.55556C3.8 7.81918 3.1732 7.22222 2.4 7.22222C1.6268 7.22222 1 7.81918 1 8.55556V10.3333C1 14.0152 4.13401 17 8 17C11.866 17 15 14.0152 15 10.3333V5.88889C15 5.15251 14.3732 4.55556 13.6 4.55556C12.8268 4.55556 12.2 5.15251 12.2 5.88889M6.6 3.22222V8.11111M6.6 3.22222V2.33333C6.6 1.59695 7.2268 1 8 1C8.7732 1 9.4 1.59695 9.4 2.33333V3.22222M9.4 3.22222V8.11111M9.4 3.22222C9.4 2.48584 10.0268 1.88889 10.8 1.88889C11.5732 1.88889 12.2 2.48584 12.2 3.22222V5.88889M12.2 5.88889V8.11111" stroke="#50FFFF" stroke-linecap="round" stroke-linejoin="round"/>
                </Svg>
        },
        {
            id: 0,
            ...
            online: true,
            name: '@KitshunaFowyu',
            data: {text: 'Raise hand', color: '#6F6F6F'},
            added: <Svg width={vw(5.8)} height={vw(5.6)} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <Path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 12.5V12.5C9.11917 12.5 8 11.3808 8 10V5C8 3.61917 9.11917 2.5 10.5 2.5V2.5C11.8808 2.5 13 3.61917 13 5V10C13 11.3808 11.8808 12.5 10.5 12.5Z" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M15.5 8.33337V10C15.5 12.7617 13.2617 15 10.5 15V15C7.73833 15 5.5 12.7617 5.5 10V8.33337" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M10.5002 15V17.5" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    <Path d="M7.0166 17.5H13.9833" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                </Svg>
    ...
    const [callAct, setCallACT] = useState(CallAction);
                ...
                <Animated.View style = {[styles.addedModal, {transform: [{ translateY: screenY }]}]}>
                    ...
                    >
                        ...
                        <View style = {styles.topButton}>
                            ...
                            <TouchableOpacity style = {[styles.icon, { backgroundColor: callState.camera ? 'white' : '#75757520' }]}
                                onPress = {handleCamera}
                            >
                                <Svg width={vw(6.1)} height={vw(6.1)} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <Path d="M4 4C2.34315 4 1 5.34315 1 7V15C1 16.6569 2.34315 18 4 18H13C14.3527 18 15.4962 17.1048 15.8705 15.8745M16 11L19.6343 7.36569C20.0627 6.93731 20.2769 6.72312 20.4608 6.70865C20.6203 6.69609 20.7763 6.76068 20.8802 6.88238C21 7.02265 21 7.32556 21 7.93137V14.0686C21 14.6744 21 14.9774 20.8802 15.1176C20.7763 15.2393 20.6203 15.3039 20.4608 15.2914C20.2769 15.2769 20.0627 15.0627 19.6343 14.6343L16 11ZM16 11V8.8C16 7.11984 16 6.27976 15.673 5.63803C15.3854 5.07354 14.9265 4.6146 14.362 4.32698C13.7202 4 12.8802 4 11.2 4H8.5M1 1L21 21" stroke={callState.camera ? 'black' : 'white'} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <ScrollView>
                            <View style = {styles.topTitle}>
                                <Text style = {[styles.Title, {marginBottom: vw(6.4)}]}>
                                    Call Actions
                                </Text>
                            {
                            ...
                            <View style = {[styles.topTitle, {height: vw(120)}]}>
                                <Text style = {[styles.Title, {marginBottom: vw(6.4)}]}>
                                    Members
                                </Text>
                            {
