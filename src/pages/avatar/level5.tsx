        ...
        <View>
            ...
            <View style = {styles.container}>
                <View style = {styles.backImgStyle}>
                    <ImageBackground source = {require('../../../assets/images/level5.png')}
                    ...
                    >
                        ...
                        <View style = {{width: vw(80), flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                            <Text style = {{fontSize: vw(3.3), fontFamily: 'TT Firs Neue Trial Regular', color: 'white', marginTop: vw(6.3)}}>
                                Claim reward
                            </Text>
                            <View style = {[styles.btn, {width: vw(45.83)}]}>
                                <Text style = {{fontSize: vw(3.9), fontFamily: 'NeueMetana-Bold', color: 'white'}}>
                                    Continue
                                </Text>
                            </View>
                        </View>
