...
const CustomTopCard = ({ avatar, avatarName, avatarContent, joinState, radius }) => {
    ...
    return (
            ...
            >
                ...
                </View>
                {
                    ...
                    :
                    <View style = {{ width: vw(20.8), aspectRatio: 75/30, borderRadius: vw(5), backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center', borderWidth: vw(0.3), borderColor: '#595959' }}>
